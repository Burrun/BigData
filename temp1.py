...
def run_regression_analysis(df, target, output_dir):
    ...
    best_iter = int(np.median(best_iters))    # 또는 np.mean / max 등
    ...
    model_txt = model.booster_.model_to_string(num_iteration=-1)
